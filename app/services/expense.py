...
class ExpenseService:
    ...
    async def add_transaction(
        ...
        category falls back to ``"other"`` — categorisation is a soft
        dependency but every row still ends up with a usable label.
        """
        if not merchant:
        ...
        # Auto-categorize. Falls back to "other" on LLM failure.
        category = await categorize_or_default(merchant, default="other")
